0-create-firebase project name tinder-clone and save config in firebase.js
1-npm create-react-app tinder-clone
2-cd tinder-clone
3-npm start
4-rfce==> for creating react template
5-npm install @material-ui/core
6-npm install @material-ui/icons
7-npm install react-router-dom
8-npm install --save react-tinder-card
9-npm i firebase
...
3 now hit npm run build command to generate production build file
4 firebase deploy
